...
<font color="purple" size="+1">1. Check connected phone</font>

>Syntax: adb devices
![android_adb_devices](http://londatiga.net/images/adb/android_adb_devices.jpg)

<font color="purple" size="+1">2. Login to Android shell</font>
...
<font color="purple" size="+1">3. Some usefull shell commands</font>
...
<font color="purple" size="+1">4. Install application</font>
...
<font color="purple" size="+1">5. Copy files from phone to local drive</font>
...
<font color="purple" size="+1">6. Copy files from local drive to phone</font>
